...
public class MyDBhandler extends SQLiteOpenHelper {
    ...
    public void addContact(Contact contact){
        ...
        values.put(Column_NAME, contact.getContact());
        values.put(Column_Address, contact.getNumber());
        values.put(Column_SecretKey, contact.getSecretkey());
    ...
    public void upDateRow(Contact contact){
        ...
        values.put(Column_SecretKey, contact.getSecretkey());
        SQLiteDatabase db = getWritableDatabase();
        db.update(Table_Keys, values, "name = ?",new String[]{contact.getContact()});
        db.close();
    }
    ...
    public String getSecretKey(String name){
      ...
      SQLiteDatabase db = this.getReadableDatabase();
        Cursor c = db.query(Table_Keys, new String[]{Column_ID, Column_NAME, Column_Address, Column_SecretKey}, Column_NAME  + "=?",new String[]{name}, null, null, null);
